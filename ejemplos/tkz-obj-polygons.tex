...
\pgfkeys{%
/defregpoly/.cd,
name/.code    =  {  \global\def\tkz@regpolname{#1}},
sides/.code   =  {  \global\def\tkz@regpolsides{#1}},
center/.code  =  {  \global\def\tkz@numregpol{0}},
side/.code    =  {  \global\def\tkz@numregpol{1}}
} 
...
\begingroup
\pgfkeys{/defregpoly/.cd,center,name=P,sides=5}   
...
%  \foreach \v in {1,2,...,\tkz@regpolsides}
%    {%
%    \pgfmathsetmacro{\tkz@regangle}{360/\tkz@regpolsides*\v}  
%    \tkzDefPointBy[rotation= center tkz@RegPolCenter angle \tkz@regangle](#2)   
%    \tkzGetPoint{\tkz@regpolname\v}%
%    }   
...
/deflabelregpoly/.cd,
name/.code    =  {  \global\def\tkz@regpolname{#1}},
sep/.code     =  {  \global\def\tkz@regpolsep{#1}},
}   
...
\begingroup
\pgfkeys{/deflabelregpoly/.cd,name=P,sep=1.1}   
\pgfqkeys{/deflabelregpoly}{#1}  
 \foreach \v [count=\vi from 1]  in {#3}  \path (#2) to [pos=1.1] node {$\v$} (\tkz@regpolname\vi) ;    
\endgroup
} 
