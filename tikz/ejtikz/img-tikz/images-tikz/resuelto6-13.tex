...
%%%%%%%%%%%%%%%%%%%%%
\draw[color=blue,ultra thick]           (O1)node[
                               label = {}]{}-- +(B1) node[
                               label = {}] {};
\draw[color=blue,ultra thick]           (O1)node[
                               label = {}]{}-- (C1) node[
...
\draw[blue,ultra thick] (-1.5,0) arc (360:60:1.5); 
 \pic [ultra thick,red,draw, -latex, "$\vartheta$", angle eccentricity=1.5] {angle =B1--O1--C1};
  \filldraw (O) circle (1pt) node[above left] {$O$};
\filldraw (O1) circle (1pt) node[above left] {$O$};
%%%%%%%%%cone
