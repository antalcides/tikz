...
\draw (cp)  node [xshift=-9cm,yshift=10cm,scale=3,right] { pour l'impatient};
...
\postIt{(postit)}{17}{1.75} {Fait \   avec}{} { L\raisebox{0.25\height}{A}T\raisebox{-0.25\height}{E}X et TikZ}
